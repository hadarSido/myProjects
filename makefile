...
serverManager.o: serverManager.c serverManager.h userManager.h protocol.h server.h
	$(CC) $(CFLAGS) -I $(LIST_PATH) -I $(VECTOR_PATH) -I $(HEAP_PATH) -c serverManager.c
...
clientMng.o: clientMng.c mainclientMng.c clientMng.h clientNet.h protocol.h ui.h
	$(CC) $(CFLAGS) -I $(VECTOR_PATH) -I $(HEAP_PATH) -I $(HASH_PATH) -c clientMng.c
...
protocol.o: protocol.c protocol.h 
	$(CC) $(CFLAGS) -I $(VECTOR_PATH) -I $(HEAP_PATH) -c protocol.c
...
groupManager.o: groupManager.c groupManager.h group.h
	$(CC) $(CFLAGS) -I $(HASH_PATH) -I $(QUE_PATH) -I $(VECTOR_PATH) -I $(HEAP_PATH) -c groupManager.c
