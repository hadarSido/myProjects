...
#include <stddef.h>
#include "user.h"
#include "gends/list/list.h" /*DLList funcions decleration*/
#include "gends/list/listItr.h" /*ItrList funcions decleration*/
#include "gends/list/listitrfun.h" /*ItrListForEch funcions decleration*/
#define TRUE 1
#define FALSE 0
