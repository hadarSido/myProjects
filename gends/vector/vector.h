 ...
 * @retval VECTOR_OVERFLOW if realloc dont have space
  * @retval VECTOR_NOT_INITIALIZED if vector or item are NULL
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNDERFLOW if realloc dont have space
 * @retval VECTOR_NOT_INITIALIZED if vector or pValue are NULL
 * (cover all possibilities) 
 ...
 * @retval VECTOR_SUCCESS on success
 * @retval VECTOR_NOT_INITIALIZED if vector or pValue are NULL
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR - incurrect index
 *
 * 
 */
 ...
 * @return success or error code 
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_NOT_INITIALIZED if vector or value are NULL
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR - incurrect index
 *
 * 
 */
 ...
 * @retval return 0 if vector is NULL			
 */
 ...
 *      }
 *		return i;
 * @retval return 0 if vector or action are NULL
 */
